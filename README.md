...
Dataset: Social Media User Analysis Data (Kaggle)

The dataset is fully synthetic, generated to simulate realistic Instagram usage and lifestyle patterns for the 2025-2026 period. Raw source files are not included in this repository due to size constraints. The SQL scripts assume the original data has already been loaded into a database environment.
...
AI tools were used selectively for brainstorming, editing, and improving documentation clarity. All analysis logic, SQL workflows, interpretation, and final conclusions were reviewed and validated by me.
